        ...
        <div class="container">
            <section class="quiz-section">
                ...
                <h1 style="margin-top: -6px;"><img class="logo" width="6%" style="margin-top:12px" src="assets/imagem/pngegg.png">  PokeQuiz</h1>
                    ...
                    <h2 class="question-text">4. O Pokemon do tipo fogo é:</h2>
                    
                    <div class="option-list">
                        <div class="option">
                            <input type="radio" id="respostaA" name="resposta" value="A">
                            <label for="respostaA"><span>A. Naruto</span></label>
                        </div>
                        <div class="option">
                            <input type="radio" id="respostaB" name="resposta" value="B">
                            <label for="respostaB"><span>B. Moltres</span></label>
                        </div>
                        <div class="option">
                            <input type="radio" id="respostaC" name="resposta" value="C">
                            <label for="respostaC"><span>C. Ninetales</span></label>
                        </div>
                        <div class="option">
                            <input type="radio" id="respostaD" name="resposta" value="D">
                            <label for="respostaD"><span>D. Geodude</span></label>
                        </div>
                    </div>
                    
                    <div class="quiz-footer">
                        <span class="question-total">4 de 10 questões</span>
