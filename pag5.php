            ...
            <div class="container">
                <section class="quiz-section">
                    ...
                    <h1 style="margin-top: -6px;"><img class="logo" width="6%" style="margin-top:12px" src="assets/imagem/pngegg.png">  PokeQuiz</h1>
                        ...
                        <h2 class="question-text">5. Qual destes é inicial da 3º geração?</h2>
                        
                        <div class="option-list">
                            <div class="option">
                                <input type="radio" id="respostaA" name="resposta" value="A">
                                <label for="respostaA"><span>A. Snivy</span></label>
                            </div>
                            <div class="option">
                                <input type="radio" id="respostaB" name="resposta" value="B">
                                <label for="respostaB"><span>B. Piplup</span></label>
                            </div>
                            <div class="option">
                                <input type="radio" id="respostaC" name="resposta" value="C">
                                <label for="respostaC"><span>C. Mudkip</span></label>
                            </div>
                            <div class="option">
                                <input type="radio" id="respostaD" name="resposta" value="D">
                                <label for="respostaD"><span>D. Chinchar</span></label>
                            </div>
                        </div>
                        
                        <div class="quiz-footer">
                            <span class="question-total">5 de 10 questões</span>
